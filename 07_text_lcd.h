...
void portOut(void)
{
      ...
      DDRG = 0x0F;	// PORTG의 하위 4비트를 출력으로 //0xFF
}
...
{
	sbi(LCD_CTRL, LCD_EN);  //LCD Enable //portg = 0b00010;
	cbi(LCD_CTRL, LCD_RW);
...
{
	//PORTG = 0b00000100 | 0b00000000 | 0b00000000;
	//PORTA = 0b00111000;
	//PORTG = 0x00000000;
	...
	//PORTG = PORTG | (1<<LCD_EN);
	//PORTG = PORTG | (0<<LCD_RW0);
	//PORTG = PORTG | (0<<LDC_RS);
